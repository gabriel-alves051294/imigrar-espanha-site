...
The project maintainer (Gabriel Alves Izaias) is responsible for clarifying and enforcing standards of acceptable behavior and will take appropriate and fair corrective action in response to any behavior deemed inappropriate, threatening, offensive, or harmful.
...
The maintainer will follow these Community Impact Guidelines in determining consequences for any action deemed in violation:

### 1. Correction
**Impact:** Use of inappropriate language or other unprofessional behavior.  
**Consequence:** A private written warning with clarity around the violation and an explanation of why it was inappropriate.
